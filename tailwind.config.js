...
module.exports = {
  ...
  // Remove safelist entirely - Tailwind will auto-detect classes
  theme: {
    extend: {
      colors: {
        green: {
      ...
      boxShadow: {
        ...
        'glow-green': '0px 0px 20px rgba(0, 211, 149, 0.4), 0px 0px 40px rgba(0, 211, 149, 0.2)',
        'glow-beige': '0px 0px 20px rgba(249, 238, 210, 0.4), 0px 0px 40px rgba(249, 238, 210, 0.2)',
        'glow-green-strong': '0px 0px 15px rgba(0, 211, 149, 0.6), 0px 0px 30px rgba(0, 211, 149, 0.3), 0px 0px 45px rgba(0, 211, 149, 0.1)',
        'glow-beige-strong': '0px 0px 15px rgba(249, 238, 210, 0.6), 0px 0px 30px rgba(249, 238, 210, 0.3), 0px 0px 45px rgba(249, 238, 210, 0.1)',
      },
    },
  },
